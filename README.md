...
Сейчас в комплекте есть `Something broke` / `Something went wrong` (en) и `Что-то сломалось...` (ru). Для новых языков достаточно добавить этот список в соответствующий locale-файл.
