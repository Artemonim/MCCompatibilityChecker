...
3. Open Legacy Launcher and select the desired version.
...
5. When the script asks, hover your cursor over the "Play" button in the launcher and press Enter. Everything after that is automatic.
